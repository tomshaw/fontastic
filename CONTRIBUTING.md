...
This documentation outlines the general procedure for contributing to the fontastic repository. If you wish to contribute please be sure to read the following resources:

 - [Code of Conduct](CODE_OF_CONDUCT.md)

## Reporting Security Issues

If you've encountered a security vulnerability, please send it to [tomshaw21@gmail.com](mailto:tomshaw21@gmail.com). I will work to verify the vulnerability and patch it as soon as possible.
...
```console
$ git clone git://github.com/tomshaw/fontastic.git
$ cd fontastic
```

### Keeping Up-to-Date

Periodically, you should update your fork to match the fontastic repository.
