...
class MessageHandler {
    ...
    initialize() {
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_SYSTEM_BOOT, (event, _args) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_SAVE_DBCONNECTION, (event, options) => __awaiter(this, void 0, void 0, function* () {
            if (options.name === 'default') {
                event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_SAVE_DBCONNECTION, this.configManager.get(enums_1.StorageType.DatabaseConnections));
            }
            else {
        ...
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_DELETE_DBCONNECTION, (event, name) => __awaiter(this, void 0, void 0, function* () {
            if (name === 'default') {
                event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_DELETE_DBCONNECTION, this.configManager.get(enums_1.StorageType.DatabaseConnections));
            }
            else {
        ...
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_DROP_DATABASE, (event) => __awaiter(this, void 0, void 0, function* () {
            this.connectionManager.dropDatabase().then(() => {
                event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_DROP_DATABASE, { type: 'success', message: 'Database droped successfully' });
            }).catch((err) => {
                event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_DROP_DATABASE, { type: 'error', message: err.message });
            });
        }));
        /**
         * Font Manager
        ...
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_MESSAGE_BOX, (event, options) => __awaiter(this, void 0, void 0, function* () {
            this.fontManager.showDialogBox(options).then((response) => event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_MESSAGE_BOX, response));
        }));
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_OPEN_DIALOG, (event, options) => __awaiter(this, void 0, void 0, function* () {
            this.fontManager.showOpenDialog(options).then((response) => event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_OPEN_DIALOG, response));
        }));
        ...
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_SYNC_ACTIVATED, (event) => __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield this.connectionManager.getStoreRepository().syncActivated();
        ...
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_RESET_FAVORITES, (event) => __awaiter(this, void 0, void 0, function* () {
            const results = yield this.connectionManager.getStoreRepository().resetFavorites();
