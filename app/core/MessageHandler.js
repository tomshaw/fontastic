...
class MessageHandler {
    ...
    initialize() {
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_SYSTEM_BOOT, (event, args) => __awaiter(this, void 0, void 0, function* () {
            ...
            event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_SYSTEM_BOOT, response);
        }));
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_SYSTEM_RESET, (event, args) => __awaiter(this, void 0, void 0, function* () {
            this.getFontManager().reLaunch();
            event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_SYSTEM_RESET, {});
        }));
        /**
         * Config Manager
         */
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_SET_CONFIG, (event, args) => __awaiter(this, void 0, void 0, function* () {
            ...
            event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_SET_CONFIG, saved);
        }));
        ...
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_CLEAR_STORE, (event) => __awaiter(this, void 0, void 0, function* () {
            ...
            event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_CLEAR_STORE, response);
        }));
        /**
         * Connection Manager
         */
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_SAVE_DBCONNECTION, (event, options) => __awaiter(this, void 0, void 0, function* () {
            if (options.name === 'default') {
                event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_SAVE_DBCONNECTION, this.getConfigManager().get('database').connections);
            }
            else {
        ...
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_DELETE_DBCONNECTION, (event, name) => __awaiter(this, void 0, void 0, function* () {
            if (name === 'default') {
                event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_DELETE_DBCONNECTION, this.getConfigManager().get('database').connections);
            }
            else {
        ...
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_ENABLE_DBCONNECTION, (event, item) => {
            ...
            event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_ENABLE_DBCONNECTION, item);
        });
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_TEST_CONNECTION, (event, args) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (activeConnectionOptions.database === args.database) {
                this.getConnectionManager().isInitialized().then(() => {
                    event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_TEST_CONNECTION, { type: 'success', message: 'Connection tested successfully' });
                }).catch((err) => {
                    event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_TEST_CONNECTION, { type: 'error', message: err.message });
                });
            }
            else {
        ...
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_DROP_DATABASE, (event) => __awaiter(this, void 0, void 0, function* () {
            yield this.getConnectionManager().dropDatabase().then(() => {
                event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_DROP_DATABASE, { type: 'IPCMAIN_RESPONSE_DROP_DATABASE' });
            });
        }));
        /**
         * Font Manager
        ...
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_EXECUTE_COMMAND, (event, args) => __awaiter(this, void 0, void 0, function* () {
            yield this.getFontManager().executeCommand(args).then((response) => {
                event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_EXECUTE_COMMAND, response);
            }).catch((err) => event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_EXECUTE_COMMAND, err.message));
        }));
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_FILES_SCAN, (event, args) => __awaiter(this, void 0, void 0, function* () {
            ...
            Promise.allSettled(promises).then(() => __awaiter(this, void 0, void 0, function* () {
                ...
                event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_FILES_SCAN, result);
            }));
        }));
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_FOLDERS_SCAN, (event, args) => __awaiter(this, void 0, void 0, function* () {
            ...
            Promise.allSettled(promises).then(() => __awaiter(this, void 0, void 0, function* () {
                const result = yield this.fetchStore();
                event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_FOLDERS_SCAN, result);
            }));
        }));
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_FONT_ACTIVATION, (event, args) => __awaiter(this, void 0, void 0, function* () {
            this.getFontManager().fontInstaller(args).then((response) => __awaiter(this, void 0, void 0, function* () {
                ...
                const result = yield this.fetchStore();
                event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_FONT_ACTIVATION, result);
            })).catch((err) => event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_FONT_ACTIVATION, err.message));
        }));
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_AUTH_USER, (event, args) => __awaiter(this, void 0, void 0, function* () {
            yield this.getFontManager().systemAuthenticate(args).then((response) => {
                event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_AUTH_USER, response);
            });
        }));
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_FETCH_NEWS, (event, args) => __awaiter(this, void 0, void 0, function* () {
            yield this.getFontManager().fetchLatestNews(args).then((response) => {
                event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_FETCH_NEWS, response);
            });
        }));
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_NEWS_CONTENT, (event, url) => __awaiter(this, void 0, void 0, function* () {
            yield this.getFontManager().fetchNewsContent(url).then((response) => {
                event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_NEWS_CONTENT, response);
            });
        }));
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_MESSAGE_BOX, (event, options) => __awaiter(this, void 0, void 0, function* () {
            this.getFontManager().showDialogBox(options).then((response) => event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_MESSAGE_BOX, response));
        }));
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_OPEN_DIALOG, (event, options) => __awaiter(this, void 0, void 0, function* () {
            this.getFontManager().showOpenDialog(options).then((response) => event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_OPEN_DIALOG, response));
        }));
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_OPEN_PATH, (event, path) => __awaiter(this, void 0, void 0, function* () { return this.getFontManager().openPath(path); }));
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_OPEN_FOLDER, (event, fullPath) => __awaiter(this, void 0, void 0, function* () { return this.getFontManager().showItemInFolder(fullPath); }));
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_OPEN_EXTERNAL, (event, url) => __awaiter(this, void 0, void 0, function* () { return this.getFontManager().openExternal(url); }));
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_RELOAD_WINDOW, (event) => __awaiter(this, void 0, void 0, function* () { return this.getFontManager().reLaunch(); }));
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_EXIT, (event) => __awaiter(this, void 0, void 0, function* () { return this.getFontManager().exit(); }));
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_QUIT, (event) => __awaiter(this, void 0, void 0, function* () { return this.getFontManager().quit(); }));
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_BEEP, (event) => __awaiter(this, void 0, void 0, function* () { return this.getFontManager().beep(); }));
        /**
         * Collection
         */
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_FETCH_COLLECTIONS, (event, ...args) => __awaiter(this, void 0, void 0, function* () {
            ...
            event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_FETCH_COLLECTIONS, result);
        }));
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_CREATE_COLLECTION, (event, parentId) => __awaiter(this, void 0, void 0, function* () {
            ...
            event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_CREATE_COLLECTION, result);
        }));
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_DELETE_COLLECTION, (event, collectionId) => __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield this.getConnectionManager().getCollection().find();
            event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_DELETE_COLLECTION, result);
        }));
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_UPDATE_COLLECTION, (event, args) => __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield this.getConnectionManager().getCollection().find();
            event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_UPDATE_COLLECTION, result);
        }));
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_RESET_ENABLED, (event) => __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield this.getConnectionManager().getCollection().find();
            event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_RESET_ENABLED, result);
        }));
        /**
         * Store
         */
        ...
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_STORE_FETCH_ROW, (event, storeId) => __awaiter(this, void 0, void 0, function* () {
            ...
            event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_STORE_FETCH_ROW, result);
        }));
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_STORE_UPDATE, (event, args) => __awaiter(this, void 0, void 0, function* () {
            yield this.getConnectionManager().getStoreRepository().update(args.id, args.data);
            const result = yield this.getConnectionManager().getStoreRepository().findOne({ where: { id: args.id } });
            event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_STORE_UPDATE, result);
        }));
        // collection
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_UPDATE_COUNT, (event, collectionId) => __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield this.getConnectionManager().getCollection().find();
            event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_UPDATE_COUNT, result);
        }));
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_UPDATE_COUNTS, (event) => __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield this.getConnectionManager().getCollection().find();
            event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_UPDATE_COUNTS, result);
        }));
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_SYNC_SYSTEM, (event) => __awaiter(this, void 0, void 0, function* () {
            ...
            paths.forEach((folder) => __awaiter(this, void 0, void 0, function* () {
                promises.push(this.getFontManager().scanFolders(folder, { collection_id: 0, system: 1 }).catch((err) => AppLogger_1.default.getInstance().error(err)));
            }));
            Promise.allSettled(promises).then(() => __awaiter(this, void 0, void 0, function* () {
                const result = yield this.getConnectionManager().getStoreRepository().fetchSystemStats();
                event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_SYNC_SYSTEM, result);
            }));
        }));
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_SYNC_ACTIVATED, (event) => __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield this.getConnectionManager().getStoreRepository().syncActivated();
            event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_SYNC_ACTIVATED, result);
        }));
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_RESET_FAVORITES, (event) => __awaiter(this, void 0, void 0, function* () {
            ...
            event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_RESET_FAVORITES, results);
        }));
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_SYSTEM_STATS, (event) => __awaiter(this, void 0, void 0, function* () {
            ...
            event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_SYSTEM_STATS, results);
        }));
        /**
         * Logger
         */
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_LOGGER_CREATE, (event, args) => __awaiter(this, void 0, void 0, function* () {
            ...
            event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_LOGGER_CREATE, result);
        }));
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_LOGGER_QUERY, (event) => __awaiter(this, void 0, void 0, function* () {
            const result = yield this.fetchLogger();
            event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_LOGGER_QUERY, result);
        }));
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_LOGGER_DELETE_ITEM, (event, args) => __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield this.fetchLogger();
            event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_LOGGER_DELETE_ITEM, result);
        }));
        this.on(enums_1.ChannelType.IPCMAIN_REQUEST_LOGGER_TRUNCATE, (event) => __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield this.fetchLogger();
            event.sender.send(enums_1.ChannelType.IPCMAIN_RESPONSE_LOGGER_TRUNCATE, result);
        }));
    }
    fetchStore() {
    ...
    fetchCollection() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.getConnectionManager().getCollection().find({ order: { id: 'DESC' }, skip: 0 });
        });
    }
    fetchLogger() {
        return __awaiter(this, void 0, void 0, function* () {
