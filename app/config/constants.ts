...
export const STORE_SETTINGS_IMPORT_TYPE = 'settings.import.type';

export const STORE_SYSTEM = 'system';
...
export const STORE_DATA_COLLECTION_ID = 'data.collecton.id';
export const STORE_DATA_STORE_ID = 'data.store.id';